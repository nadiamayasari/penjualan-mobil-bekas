  ...
  <body>
    ...
    <div class="container mt-4">
        ...
        <div class="d-flex flex-row brand-container gap-3 py-2">
          ...
          ?>
            ...
            <div class="brand-card">
                <img src="foto_merek/<?= $row['foto_merek'] ?>" alt="Toyota">
    	...
    	<div class="container">
			...
			<?php
              include 'koneksi.php';
              $query = "SELECT a.*, b.*, c.status_penjualan as status_penjualan,d.* FROM produk a LEFT JOIN detail_produk d ON a.id_produk=d.id_produk LEFT JOIN merek b ON a.id_merek=b.id_merek LEFT JOIN penjualan c ON a.id_produk=c.id_produk WHERE b.id_merek = '$id_merek' ORDER BY a.id_produk DESC";
